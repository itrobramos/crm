...
<head>
    ...
    <title>Entrenamiento Positivo</title>
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single_recepie text-center">
                        <div class="recepie_thumb">
                            <img src="{{env('DEPLOY_URL')}}/img/recepie/menu7.jpg" alt="">
                        </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single_recepie text-center">
                        <div class="recepie_thumb">
                            <img src="{{env('DEPLOY_URL')}}/img/recepie/menu10.jpg" alt="">
                        </div>
                        <!-- <h3>Juegos</h3>
                        <span>Básico</span>
                        <p>Sesiones 3</p>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single_recepie text-center">
                        <div class="recepie_thumb">
                            <img src="{{env('DEPLOY_URL')}}/img/recepie/menu8.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="customer_feedback_area">
        <div class="container">
            <center>
                <h2>Pedro Guardado</h2>
            </center>

            <div class="row justify-content-center">
                <ul>
                    <li>Servicio de entrenamiento canino a domicilio en toda el área metropolitana.</li>
                    <br>
                    <p>Aprende a trabajar con tu perrito entendiendo la forma en que el recibe la información y
                        formando un canal de comunicación eficaz.
                        Perzonalizamos tu plan de entrenamiento para adecuarlo a tus necesidades dependiendo de
                        estilo de vida, horarios y rutinas.
                        La edad ideal? Desde el día 1 que llega a casa
                        Todo el entrenamiento es a base de reforzamiento positivo, con premios y a través del juego!
                        Para que dar un golpe si divirtiendonos podemos llegar a mejores resultados!</p>
                </ul>
